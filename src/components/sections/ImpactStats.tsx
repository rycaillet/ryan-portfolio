...
const stats = [
  ...
  { value: '4+', label: 'Portfolio projects planned' },
  { value: '100%', label: 'Mobile-first approach' },
  { value: 'A11y', label: 'Accessibility focused' },
]
    ...
    >
      <div className="grid gap-4 rounded-[2rem] border border-white/10 bg-white/[0.04] p-4 backdrop-blur md:grid-cols-4">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className="rounded-3xl border border-white/10 bg-slate-950/50 p-6 text-center"
          >
